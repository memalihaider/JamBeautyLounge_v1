      ...
      <Card className="w-full max-w-md border-white/5 bg-white/[0.02] backdrop-blur-2xl rounded-[3rem] shadow-2xl relative z-10 overflow-hidden">
        ...
        <CardContent className="px-10 pb-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full h-16 bg-secondary hover:bg-white text-black font-black tracking-[0.2em] text-xs rounded-2xl transition-all duration-500 shadow-xl shadow-secondary/10"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
