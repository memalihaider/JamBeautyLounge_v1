            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <a 
                  ...
                  className="w-12 h-12 rounded-2xl border border-white/10 flex items-center justify-center hover:bg-secondary hover:text-white transition-all duration-700 shadow-2xl"
                >
          ...
          <div className="space-y-12">
            ...
            <ul className="space-y-10 text-white/70 text-sm font-light">
              ...
              <li className="flex items-center gap-5 group">
                ...
                <a href="mailto:hello@jambeautylounge.com" className="text-xs hover:text-white transition-colors">
